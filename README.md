...
The improved elliptic curve scalar multiplication algorithm depends on the Jacobian elliptic curve addition algorthim known as "madd-2004-hmv", which is specific to curves where a = 0 and assumes Z2 = 1. This fits Secp256k1 and allows the precalculated Secp256k1 doublings to be passed as an array of type ACT. See this page on the Explicit Functions Database: https://www.hyperelliptic.org/EFD/g1p/auto-shortw-jacobian-0.html.
